...
(function(){
  ...
  probe.onload=function(){
    ...
    overlay.innerHTML='<div class="gm-entry-approved-wrap"><img class="gm-entry-approved-img" alt="" src="./019B1C8C-CF04-45E6-9A4F-FB80A4C6A3C9.png?v=139"><button class="gm-entry-approved-start" type="button" aria-label="Começar agora"></button><button class="gm-entry-approved-login" type="button" aria-label="Entrar"></button></div>';
    function closeEntry(){
  ...
  probe.src='./019B1C8C-CF04-45E6-9A4F-FB80A4C6A3C9.png?v=139';
})();